...
import { Field, FieldDescription, FieldSet, FieldGroup, FieldLegend, FieldLabel, FieldError } from "@/components/ui/field";
                    ...
                    <FieldSet>
                        <Fragment key={attribute.name}>
                            ...
                            >
                                <FieldGroup>
                                    <Field>
                                        <FieldLabel htmlFor="attribute.name"> {advancedMsg(attribute.displayName ?? "")}</FieldLabel>
            ...
            return (
                ...
                >
                    {(() => {
                        ...
                        return <FieldLegend> {groupHeaderText}</FieldLegend>;
                    })()}
                    {(() => {
                        ...
                        if (groupDisplayDescription !== "") {
                            ...
                            return <FieldDescription>{groupDescriptionText}</FieldDescription>;
                        }
...
function InputFieldByType(props: InputFieldByTypeProps) {
    ...
    switch (attribute.annotations.inputType) {
        ...
        default: {
            ...
            //     return <Input type="password" required={attribute.required} />;
            // }
